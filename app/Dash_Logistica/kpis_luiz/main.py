...
#lista_perfomance_time_logistica = [ind_localizacaoLR,ind_tempocicloLR,ind_pedidoperfeito,ind_separacao,ind_dockstocktime]
...
#lista_performance_time_transporte = [ind_leadtime,ind_coletasnoprazo,ind_entregasnoprazo,ind_avarias,ind_nps]

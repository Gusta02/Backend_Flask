...
with open(os.path.abspath('app/Dash_Logistica/kpis_luiz/queries/financeiro/query_vendas_por_unidade_por_mes.sql')) as f:
	query_vendas_por_unidade_por_mes = f.read()